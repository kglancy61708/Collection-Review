...
def _account_to_row(acc: AccountSummary, status_col_name: str) -> dict:
    return {
        ...
        "Current Balance": acc.raw_balances["Current"] or None,
        "30+ Balance": acc.raw_balances["30+"] or None,
        "60+ Balance": acc.raw_balances["60+"] or None,
        "90+ Balance": acc.raw_balances["90+"] or None,
        "120+ Balance": acc.raw_balances["120+"] or None,
        "150+ Balance": acc.raw_balances["150+"] or None,
        "180+ Balance": acc.raw_balances["180+"] or None,
        "Finance Charges": acc.raw_balances["Finance Charges"] or None,
        "Total Open Balance": acc.total_raw_balance or None,
